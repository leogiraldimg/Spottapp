...
#     expect(page).to have_xpath("//div[@class='college']//a", text: "UT001 - Faculdade Teste 001", count: 1)
...
#     expect(page).to have_xpath("//div[@class='college']//a", text: "UT002 - Faculdade Teste 002", count: 1)
